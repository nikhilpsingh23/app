    ...
    return (
        <div className="py-16 px-4 md:px-8">
            <div className="max-w-7xl mx-auto">
                <h2 className="text-center mb-10 text-3xl md:text-4xl font-bold mb-2 text-black">
                App Support We Offer
                </h2>
                

                {/* Filter Tabs */}
                <div className="max-w-[1200px] mx-auto">
                    <div className="flex justify-between items-center border-b border-[#e6d7d7] mb-12">
                        {tabs.map((tab) => (
                            <button
                                key={tab.id}
                                ...
                                className={`px-8 py-4 text-base font-medium transition-all duration-300 relative
                                    ${activeTab === tab.id 
                                        ? "text-[#c17c6c] after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-full after:h-[2px] after:bg-[#c17c6c]" 
                                        : "text-gray-600 hover:text-[#c17c6c]"}`}
                            >
                                {tab.label}
                            </button>
                        ))}
