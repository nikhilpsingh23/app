  ...
  return (
    ...
    >
      <div className="relative">
        {/* Pulse Effect */}
        <div className="absolute inset-0 bg-gradient-to-r from-[#ee83a1] via-[#b66be8] to-[#7f65e4] rounded-full animate-ping opacity-75"></div>
        
        {/* Main Button */}
        <div className="relative bg-gradient-to-r from-[#ee83a1] via-[#b66be8] to-[#7f65e4] p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300">
